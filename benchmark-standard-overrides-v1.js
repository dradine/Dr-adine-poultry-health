/* ADINE POULTRY HEALTH — VERIFIED STANDARD OVERRIDES V1
   Sources reviewed against breeder documents on 2026-08-27.
   This file only adds/updates values that are explicitly traceable to the cited source.
*/
"use strict";
(function(g){
 ...
 const lbRecords=lbWeeks.map((w,i)=>rec((i+1)*7,w));
 VERIFIED_STANDARDS.layer=VERIFIED_STANDARDS.layer||{};VERIFIED_STANDARDS.layer.lohmann=VERIFIED_STANDARDS.layer.lohmann||{};
 VERIFIED_STANDARDS.layer.lohmann["Lohmann Brown-Classic"]={sourceYear:2021,sourceType:"official-performance-standard",sourceLabel:"LOHMANN BROWN-CLASSIC Performance Data & Body Weight Tables — official breeder table",sourceUrl:"https://lohmann-breeders.com/media/2022/06/LB_Zusatzheft_Alternative-Haltung_LB-Classic_EN_06.21_V01-21_high-1.pdf",records:lbRecords};
