/* ADINE — BROILER COMPREHENSIVE PERFORMANCE REPORT V1
   Read-only aggregation/presentation model.
   RED LINE: does not write to weekly_records and does not alter weekly calculations.
*/
"use strict";
(function(global){
