/* ADINE — BROILER COMPREHENSIVE REPORT FIXES V5
...
(function(global){
  ...
  function run(){capture();setTimeout(inject,0)}
  if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',run,{once:true});else run();
  document.addEventListener('click',e=>{if(e.target?.closest?.('.report-tab[data-tab="overall"]'))setTimeout(run,0)},true);
  global.AdineBroilerComprehensiveReportFixesV1={version:'BROILER-COMPREHENSIVE-REPORT-FIXES-V5',run};
})(window);
