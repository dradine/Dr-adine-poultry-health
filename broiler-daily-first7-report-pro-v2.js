...
function render(){
 ...
 var dailyGain=d.gain!=null?d.gain:(d.age===1&&d.bw!=null&&model.initW!=null?d.bw-model.initW:null);var prevTarget=(d.age>1&&model.std&&model.std.dayWeightG)?model.std.dayWeightG[d.age-1]:null;var gainRef=d.target!=null?(d.age===1&&model.std&&model.std.chickWeightG!=null?d.target-model.std.chickWeightG:(prevTarget!=null?d.target-prevTarget:null)):null;var gainRefText=gainRef!=null?'مرجع مشتق‌شده از وزن مرجع روزانه: '+(gainRef>=0?'+':'')+F(gainRef,1)+' گرم':'مرجع افزایش وزن روزانه موجود نیست';h+=metric('افزایش وزن',dailyGain==null?'—':(dailyGain>=0?'+':'')+F(dailyGain,1)+' گرم',dailyGain==null?gainRefText:(gainRefText+(d.age===1?' · مبنا: وزن اولیه جوجه':' · نسبت به روز قبل')),dailyGain==null?'':dailyGain>=0?'good':'warn');
