...
window.ADINE_BROILER_DAILY_STANDARDS_V1 = Object.freeze({
  ...
  strains: {
    ...
    "Indian River": { producer:"Aviagen", day7WeightG:211, chickWeightG:44, dayWeightG:{1:44,2:59,3:82,4:110,5:141,6:175,7:211}, sourceType:"official-anchor+derived-daily", sourcePriority:1, source:"Indian River Broiler Performance Objectives + 2025 Indian River Broiler Management Handbook", rationale:"Indian River has breeder-published objectives; only the missing daily granularity is derived." },
    "Indian River FF": { producer:"Aviagen", day7WeightG:211, chickWeightG:44, dayWeightG:{1:44,2:59,3:82,4:110,5:141,6:175,7:211}, sourceType:"official-anchor+derived-daily", sourcePriority:1, source:"Indian River / Indian River FF Broiler Performance Objectives", rationale:"Uses the official Indian River performance family and keeps the daily interpolation explicitly non-official." },
