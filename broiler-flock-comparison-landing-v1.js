/* ADINE — Comparison landing screen V5
...
function addChildBack(){const r=root();if(!r||active||!compareIsActive())return;if(r.querySelector('.fc-child-back,.bb-back'))return;const b=document.createElement('button');b.type='button';b.className='fc-child-back';b.textContent='بازگشت';b.setAttribute('aria-label','بازگشت به انتخاب گزارش مقایسه‌ای');b.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();showLanding()});r.insertBefore(b,r.firstChild)}
