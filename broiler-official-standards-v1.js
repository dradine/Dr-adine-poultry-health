...
const BROILER_OFFICIAL_STANDARDS_V1 = Object.freeze({
  ...
  strains: {
    ...
    "Cobb800": { producer:"Cobb", family:"Cobb", variant:"As-Hatched", initialWeight:41, sourceYear:2026, sourceType:"official-performance-objective", sourceLabel:"Cobb800 Broiler Nutrition and Management Supplement 2026", sourceUrl:"https://www.cobbgenetics.com/assets/Cobb-Files/Cobb800_5-2026_Digital.pdf", records:[[7,200,.825],[14,463,1.046],[21,953,1.163],[28,1583,1.281],[35,2295,1.400],[42,3035,1.520],[49,3742,1.639],[56,4359,1.762]] },
    ...
    "Efficiency Plus": { producer:"Hubbard", family:"Efficiency Plus", variant:"As-Hatched", initialWeight:42, sourceYear:2025, sourceType:"official-performance-objective-partial", sourceLabel:"Hubbard Efficiency Plus Broiler Performance Objectives", sourceUrl:"https://www.hubbardbreeders.com/media/ps-broiler-leaflet-a5-efficiency-plus-en.pdf", records:[[7,null,null],[14,null,null],[21,null,null],[28,1647,1.27],[35,2330,1.41],[42,3028,1.54],[49,3704,1.67],[56,4324,1.80]], managementRecords:[[7,209,.788],[14,531,1.005],[21,1010,1.142]], managementMethod:"cross-catalog-median-same-age" },
    "Hubbard EDGE": { producer:"Hubbard", family:"EDGE", variant:"As-Hatched", initialWeight:42, sourceYear:2025, sourceType:"official-performance-objective", sourceLabel:"Hubbard EDGE Broiler Performance Objectives", sourceUrl:"https://www.hubbardbreeders.com/media/broiler-performance-objectives-edge-en.pdf", records:[[7,null,null],[14,null,null],[21,1058,null],[28,1685,1.26],[35,2383,1.38],[42,3098,1.51],[49,3789,1.64],[56,4423,1.77]], managementRecords:[[7,209,.788],[14,531,1.005],[21,null,1.142]], managementMethod:"cross-catalog-median-same-age-for-missing-metrics" },
...
function normalizeBroilerOfficialRecord(strain,index){
  ...
  const [ageDays,bodyWeight,cumulativeFcr]=s.records[index],previous=index>0?s.records[index-1]:null;
