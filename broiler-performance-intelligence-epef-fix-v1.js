...
function start(){epefRating();if(typeof MutationObserver==='undefined'){let i=0;const timer=setInterval(()=>{if(epefRating()||++i>=120)clearInterval(timer)},250);return}const root=document.getElementById('root')||document.body;const mo=new MutationObserver(()=>epefRating());mo.observe(root,{subtree:true,childList:true});setTimeout(()=>mo.disconnect(),30000)}
