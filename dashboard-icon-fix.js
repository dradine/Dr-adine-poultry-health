/* FINAL DASHBOARD ICON RENDERER — APPROVED 10-ICON SET / WHITE-DARK TEST
...
(function(){
  ...
  var SRC = 'assets/dashboard-icons-tight.png?v=20260925.74';
  ...
  css.textContent = `
    ...
    .dashboard-page .adi-exact-icon::before{
      ...
      filter:brightness(0) saturate(100%) invert(1) drop-shadow(0 0 0 #17212b) drop-shadow(1px 0 0 #17212b) drop-shadow(-1px 0 0 #17212b) drop-shadow(0 1px 0 #17212b) drop-shadow(0 -1px 0 #17212b)!important;
    }
    ...
    .dashboard-page .adi-exact-icon.adi-special-icon svg{
      ...
      filter:drop-shadow(1px 0 0 #17212b) drop-shadow(-1px 0 0 #17212b) drop-shadow(0 1px 0 #17212b) drop-shadow(0 -1px 0 #17212b)!important;
    }
