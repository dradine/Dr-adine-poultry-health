...
(function () {
    ...
    /* The four generic fields are unwanted duplicates. The dedicated block
       below is the ONLY production section and is conditional for layer/breeder. */
    ...
    function addProductionSection(){
        ...
        wrap.setAttribute("data-production-baseline","true");
        wrap.className="form-grid full production-baseline";
        wrap.style.cssText="display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin:12px 0;padding:14px;border:1px solid #dfe8e3;border-radius:12px;background:#f7faf8;";
        wrap.innerHTML=`
    ...
    function init(){
        ...
        autoFillBirds();updateDensity();updateProductionVisibility();watchForDuplicates();
    }
