...
function list(){var x=els(),c=catalog(),k=pkey(x.t&&x.t.value),a=c&&c[k]&&c[k].genetics;return Array.isArray(a)&&a.length?a:(FALLBACK[k]||[])}
function reset(sel,placeholder){if(!sel)return;sel.innerHTML='';var o=document.createElement('option');o.value='';o.textContent=placeholder;sel.appendChild(o)}
function add(sel,text,value){var o=document.createElement('option');o.value=String(value==null?'':value);o.textContent=String(text==null?'':text);sel.appendChild(o)}
