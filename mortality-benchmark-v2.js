/* ADINE MORTALITY BENCHMARK V2 — weekly broiler mortality management curve
   ...
   - Published commercial-farm data show first-week mortality is highest and
     subsequent weekly mortality is generally lower, with some late-cycle rise.
   This is a MANAGEMENT benchmark, not a genetic performance claim.
*/
(function(g){"use strict";
const VERSION="2026.2-mortality-weekly";
const BROILER_WEEKLY={1:1.00,2:0.50,3:0.30,4:0.20,5:0.20,6:0.30,7:0.30,8:0.30};
