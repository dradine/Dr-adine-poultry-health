...
const controllerSource=fs.readFileSync('broiler-pi-controller-v23.js','utf8');
...
assert.match(presenterSource,/version:'V11.8'/);
assert.match(controllerSource,/Report\?\.version==='V11.8'/);
assert.doesNotMatch(controllerSource,/Report\?\.version==='V11.6'/);
