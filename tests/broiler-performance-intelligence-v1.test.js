...
const health = [{ day: 7, severity: 1 }, { day: 14, severity: 2 }, { day: 21, severity: 3 }, { day: 28, severity: 4 }];
const perf = [{ day: 8, value: 100 }, { day: 15, value: 90 }, { day: 22, value: 80 }, { day: 29, value: 70 }];
...
const market = A.marketOptimization({ candidates: [{ ageDays: 35, bodyWeightKg: 2.2, fcr: 1.45 }, { ageDays: 42, bodyWeightKg: 2.7, fcr: 1.55 }], targetWeightKg: 2.5, livePricePerKg: 1.5, feedPricePerKg: 0.5 });
