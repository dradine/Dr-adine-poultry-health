...
const rows=[
  {week_number:1,age_days:7,average_weight_g:214,fcr:.772,cumulative_fcr:.772,standard_weight:214,official_weekly_fcr:.772,official_cumulative_fcr:.772,management_weekly_fcr:.80,targetAuthority:"canonical-weekly-report"},
...
assert.strictEqual(out.engineVersion,"BROILER-REPORT-V8.1");
