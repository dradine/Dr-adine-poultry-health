...
for(const token of ["reports.css","standard-data.js","standards-resolver-core-v1.js","broiler-report-engine.js","reports-router.js","reports.js","data-tab=\"weekly\"","data-tab=\"overall\"","data-tab=\"compare\""])assert.ok(html.includes(token),`missing report shell token: ${token}`);
